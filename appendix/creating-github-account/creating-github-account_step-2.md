...
![GitHub Mark](../../../images/unit-1-preparing-your-development-environment/github/GitHub-Mark-64px.png)
...
##### Open Git Bash
![Open Git Bash](../../../images/unit-1-preparing-your-development-environment/github/github-create-ssh-key_3.JPG)
...
![Enter Command](../../../images/unit-1-preparing-your-development-environment/github/github-create-ssh-key_4.JPG)
...
![Enter Passphrase](../../../images/unit-1-preparing-your-development-environment/github/github-create-ssh-key_5.JPG)
...
![Activate the SSH Agent](../../../images/unit-1-preparing-your-development-environment/github/github-add-ssh-agent_2.JPG)
> **Note** - On Git Bash, the SSH-Agent is already activated, but you can check your PID using the following command:

 ```
 $eval "$(ssh-agent -s)"
 ```
 ![Evaluate the SSH Agent](../../../images/unit-1-preparing-your-development-environment/github/github-add-ssh-agent_1.JPG)

##### Add SSH Key to ```ssh-agent```
* Enter this command: ```ssh-add ~/.ssh/id_rsa```

![Add the SSH Key to the SSH Agent](../../../images/unit-1-preparing-your-development-environment/github/github-add-ssh-agent_3.JPG)
