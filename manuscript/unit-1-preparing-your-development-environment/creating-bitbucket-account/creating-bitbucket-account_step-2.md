...
##### Open Git Bash
![Open Git Bash](../../../images/unit-1-preparing-your-development-environment/bitbucket/bitbucket-create-ssh-key_3.JPG)
...
![Enter Command](../../../images/unit-1-preparing-your-development-environment/bitbucket/bitbucket-create-ssh-key_4.JPG)
...
![Enter Passphrase](../../../images/unit-1-preparing-your-development-environment/bitbucket/bitbucket-create-ssh-key_5.JPG)
...
> **Note** - On Git Bash, the SSH-Agent is already activated, but you can check your PID using the following command:
 ...
 $eval "$(ssh-agent -s)"
 ```
 ![Evaluate the SSH Agent](../../../images/unit-1-preparing-your-development-environment/bitbucket/bitbucket-add-ssh-agent_1.JPG)

##### Add SSH Key to ```ssh-agent```
* Enter this command: ```ssh-add ~/.ssh/id_rsa```

![Add the SSH Key to the SSH Agent](../../../images/unit-1-preparing-your-development-environment/bitbucket/bitbucket-add-ssh-agent_3.JPG)
